...
1. Drawing Digits:
    ...
    <p align="center">
        <img src="./images/1.1_digit_draw.png" width="550">
    </p>
    - Use `Show the matrix` button to show the matrix
    <p align="center">
        <img src="./images/1.2_show_matrix.png" width="550">
    </p>
    - Use `Clear` button to clear the canvas
    <p align="center">
        <img src="./images/1.3_clear.png" width="550">
    </p>
...
2. Predefined Digits:
    ...
    <table>
        <tr>
            <td><img src="images/2.0.png" width="300"></td>
            <td><img src="images/2.1.png" width="300"></td>
            <td><img src="images/2.2.png" width="300"></td>
            <td><img src="images/2.3.png" width="300"></td>
            <td><img src="images/2.4.png" width="300"></td>
        </tr>
    </table>
    <table>
        <tr>
            <td><img src="images/2.5.png" width="300"></td>
            <td><img src="images/2.6.png" width="300"></td>
            <td><img src="images/2.7.png" width="300"></td>
            <td><img src="images/2.8.png" width="300"></td>
            <td><img src="images/2.9.png" width="300"></td>
        </tr>
    </table>
...
3. Image Manipulation:
    ...
    <table>
        <tr>
            <td><img src="images/3.1_noise.png" width="300"></td>
            <td><img src="images/3.2_noise.png" width="550"></td>
        </tr>
    </table>
    - `Negative`: Inverts the image colors
    <p align="center">
        <img src="./images/3.3_neg.png" width="550">
    </p>
    - Arrow buttons (`↑`, `↓`, `←`, `→`): Shift the image in different directions
    <table>
        <tr>
            <td><img src="images/3.4_move.png" width="550"></td>
            <td><img src="images/3.5_move.png" width="550"></td>
        </tr>
    </table>
...
4. Recognition:
    ...
    <p align="center">
        <img src="./images/4_predict.png" width="800">
    </p>
